"use strict";
        ...
        function comparar(usuario){
            ...
            if(ban==1){
                ...
                if(color == "blan"){
                    document.body.style.cssText='background-image: url(media/fondo2.jpg); ';
                }else if(color == "rojo"){
                   document.body.style.cssText='background-image: url(media/azul.jpg); ';
                }else if(color == "negr"){
                    document.body.style.cssText='background-image: url(media/verde.jpg); ';
                }
                if(fontSize<0.1)
                    fontSize=0.1;
